...
function FeatureCard({ title, description, icon }: FeatureCardProps) {
  return (
    <div>
      <div className="inline-flex items-center justify-center w-14 h-14 rounded-sm bg-linear-to-br from-orange-500 to-orange-600 text-white mb-6 shadow shadow-orange-500/20">
